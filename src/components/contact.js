...
export const Contact= ()=>{
    ...
    return (
        <div id="main_div">
        <header>
            <div id="header_subdiv1">
            <div className="logo">
                <img src="/images/FCcLogo.png" />
            </div>
            <div id="header_sub_subdiv">
                <label id="fcc_label">Finance And Consulting Club</label>
            </div>
            </div>
            
            <div id="header_button">
                <a href="" target="_self" className="header_button_label">Home</a>
                <a href="" target="_self" className="header_button_label">Sponser</a>
                <a href="" target="_self" className="header_button_label">About us</a>
            </div>
        </header>
